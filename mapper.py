# Ran on windows 10 x64, python 3.7.2
# Code used for creating the FoodOntoMap mapping. Change file paths and parameters as needed.
...
def mapper(curated_collection, uncurated_collection, verbose = False):
    ...
    for onto in ["FOODON", "SNOMEDCT", "OF"]:
        ...
        for f in files:
            ...
            # ------ Reading and formatting foodie-hansard data ------ #
...
def mapping_to_csv(data, fname):
    ...
    with open(fname, 'w') as f:
        f.write("HANSARD CORPUS|FOODON|SNOMEDCT|OF\n")
        for key in data:
            ...
            f.write(key.strip() + "|" + B_kod +  "|" +  C_kod + "|" + D_kod + "\n")
...
if __name__ == '__main__':
    ...
    # Creating the FoodIE-Hansard data set. (A)
    #collections = []
    ...
    #mapping_to_csv(ret, './data/maps/map.csv')
    print("Mapping done.")